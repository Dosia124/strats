...
TDS:Loadout("Trapper", "Hacker", "Gatling Gun", "Mercenary Base", "EvolvedKingpin")
TDS:Mode("Fallen")
...
TDS:Place("EvolvedKingpin", 17.847015380859375, 0.9868488311767578, 33.962745666503906) --11
