...
TDS:Upgrade(8)
TDS:Upgrade(8)
TDS:Place("Hacker", 6.097320556640625, 0.9701399803161621, 30.797021865844727) --12
TDS:Upgrade(12)
TDS:Upgrade(12)
TDS:Place("Hacker", 22.965129852294922, 0.9872190952301025, 28.965984344482422) --13
TDS:Upgrade(13)
TDS:Upgrade(13)
TDS:Upgrade(12)
TDS:Upgrade(12)
TDS:Upgrade(13)
TDS:Upgrade(13)
TDS:Ability(12, "Hologram Tower", {towerPosition = Vector3.new(-27.22711753845215, 0.9885187149047852, -26.59650230407715), towerToClone = 8}, true)
TDS:Ability(13, "Hologram Tower", {towerPosition = Vector3.new(-27.22711753845215, 0.9885187149047852, -26.59650230407715), towerToClone = 8}, true)
TDS:Upgrade(9)
TDS:SetOption(9, "Unit 1", "Riot Guard")
TDS:SetOption(9, "Unit 2", "Riot Guard")
TDS:SetOption(9, "Unit 3", "Riot Guard")
TDS:Place("Mercenary Base", -30.900976181030273, 0.9912862777709961, -33.500831604003906) --10
TDS:Upgrade(10)
TDS:Upgrade(10)
TDS:Upgrade(10)
TDS:Upgrade(10)
...
TDS:Place("Mercenary Base", -30.837772369384766, 0.9894695281982422, -28.96784019470215) --11
TDS:Upgrade(11)
TDS:Upgrade(11)
TDS:Upgrade(11)
TDS:Upgrade(11)
...
TDS:Place("Crook Boss", 16.078807830810547, 0.974362850189209, 18.902034759521484) --11
